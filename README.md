...
Create a `.env` file in the project root (or set variables in your host, e.g. Railway).
...
**Railway / cloud:** See [DEPLOYMENT.md](DEPLOYMENT.md) for Railway setup. Use a persistent volume or external DB so data survives redeploys.
