...
(function () {
  ...
  function render(d) {
    ...
    root.innerHTML = html + "</ul></section>"; root.setAttribute("aria-busy", "false");
  }
  ...
  }).catch(function () { statusEl.className += " err"; statusEl.innerHTML = '<span class="dot"></span>Could not load Baro'; root.innerHTML = '<div class="tool-card">Void Trader data is unavailable.</div>'; root.setAttribute("aria-busy", "false"); });
