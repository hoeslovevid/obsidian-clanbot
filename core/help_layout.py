...
class HelpHomeLayout(ui.LayoutView):
    ...
    def __init__(
        ...
        *,
        ...
        lines = [
            "## Command Reference",
            "Pick a category, or use **`/search`**, **`/menu`**, **`/recent`**, **`/wallet`**.",
            "",
            "**Categories:** economy · warframe · community · mod · tools · giveaways",
        ]
        if is_mod:
            lines.append("**Mods:** `/admin dashboard` · `/mod purge` · `/automod status`")
        lines.append("")
