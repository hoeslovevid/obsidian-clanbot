...
def load_all_commands(bot):
    ...
    command_modules = [
        ...
        "commands.moderation.mod_kpi_setup",
        "commands.moderation.feedback_setup",
        ...
        "commands.moderation.audit_log",
        "commands.moderation.guild_branding",
